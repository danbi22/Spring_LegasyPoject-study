...
@RequiredArgsConstructor // final로 선언된 필드를 초기화하는 생성자. 2. (2) final 변수를 초기화할 수 있는 생성자를 작성
@Slf4j
public class PostService {
    ...
    // 2. 생성자에 의한 의존성 주입
    //  (1) 필드를 final로 선언 -> final은 반드시 초기화해야한다.
...
//        List<Post> list = postRepository.selectOrderByIdDesc();
         ...
         * for(Post p : list) {
         *     PostListDto dto = PostListDto.formEntity(p);
         *     list.add(dto);
         * }
         * return list;
         */
